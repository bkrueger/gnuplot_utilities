...
gpsp_subplot_label(label, pos_x, pos_y, size_x, size_y) = "set object rectangle center graph ".sprintf("%f", pos_x).",".sprintf("%f", pos_y)." size screen ".sprintf("%f", size_x).",".sprintf("%f", size_y)." fs solid fc rgb \"#000000\" front; set label '".label."' at graph ".sprintf("%f", pos_x).",".sprintf("%f", pos_y)." center tc rgb \"#FFFFFF\" front"
...
gpsp_subplot_label_bottom_left(label, size, margin) = gpsp_subplot_label(label, \
...
gpsp_subplot_label_bottom_right_multi(label, size, margin, x_multi, y_multi) = gpsp_subplot_label(label, \
...
gpsp_subplot_label_top_left_multi(label, size, margin, x_multi, y_multi) = gpsp_subplot_label(label, \
				                                                   gpfs_screen_to_graph_x_size(margin + 0.5*size)/x_multi, \
...
gpsp_subplot_label_top_right_multi(label, size, margin, x_multi, y_multi) = gpsp_subplot_label(label, \
				     	   	   	    	       	            1 - gpfs_screen_to_graph_x_size(margin + 0.5*size)/x_multi, \
										    1 - gpfs_screen_to_graph_y_size(margin + 0.5*size)/y_multi, size, size)